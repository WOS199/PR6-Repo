// Initialisation des valeures des éléments à ajouter.
let imgToAdd = "";
let titleToAdd = "";
let catToAdd = "";


const fetchWorks = fetch("http://localhost:5678/api/works").then((response) => response.json());
const fetchCategories = fetch("http://localhost:5678/api/categories").then((response) => response.json());
    ...
    function reset() {
      ...
      function OpenProjectForm() {
        ...
        const addProjectHTML = `
          ...
          // Au clic de "ajouter une photo", la phase 2 de la modal se génère. 
